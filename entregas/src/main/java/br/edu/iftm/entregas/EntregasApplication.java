    ...
    public class EntregasApplication implements CommandLineRunner {
        ...
        private static final Logger logger = LoggerFactory.getLogger(EntregasApplication.class);
        ...
        public void run(String... args) throws Exception {
            ...
            logger.info("Pacotes: {}", pacote);
            logger.info("Rastreamentos: {}", rastreamento); 
            logger.info("Endereços: {}", endereco);
        }
    }
