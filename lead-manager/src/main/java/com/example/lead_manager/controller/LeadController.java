...
public class LeadController {
    ...
    public Lead createLead(@RequestBody(description = "Lead to be created", required = true) Lead lead) {
    ...
    public ResponseEntity<Lead> updateLead(@PathVariable Long id, @RequestBody(description = "Updated lead details", required = true) Lead leadDetails) {
        Optional<Lead> lead = leadService.findById(id);
        if (lead.isPresent()) {
